...
set -gx fish_color_host --reset
set -gx fish_color_host_remote yellow
set -gx fish_color_keyword eda792
set -gx fish_color_match --background=96cbfe
set -gx fish_color_normal --reset
set -gx fish_color_operator brgreen
set -gx fish_color_option eda792
set -gx fish_color_param magenta
set -gx fish_color_quote green
set -gx fish_color_redirection cyan --bold
set -gx fish_color_search_match white --bold --background=brblack
