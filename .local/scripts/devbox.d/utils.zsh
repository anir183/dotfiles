...
export DEVBOX_ARCH_PROGRAMS=${DEVBOX_ARCH_PROGRAMS:-"debugedit fakeroot openssl pkg-config zoxide nvim perl-error perl-mailtools perl-timedate zlib-ng compiler-rt lld rust base-devel eza yazi bat"}
