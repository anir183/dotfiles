...
function create_container() {
	local create_cmd="distrobox create --name $container_name --image $image_name --hostname $container_name --home $DEVBOX_DIR/$container_name --additional-packages \"$DEVBOX_INITAL_PROGRAMS\""
	cmd_run $create_cmd
}
